"""
Django settings for withered_leaf_39834 project.
...
ROOT_URLCONF = 'withered_leaf_39834.urls'
...
WSGI_APPLICATION = 'withered_leaf_39834.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_leaf_39834 API",
    "DESCRIPTION": "API documentation for withered_leaf_39834 App",
    "VERSION": "v1",
}
